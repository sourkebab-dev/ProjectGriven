...
void UCharacterPersistanceSystem::LoadData(FPersistedCharacterData InCharacterData)
{
	...
	if (this->CompContext.Store) {
		this->CompContext.Store->InfoModule.InstanceGuid = InCharacterData.Info.CharacterId;
		this->CompContext.Store->InfoModule.InstanceName = InCharacterData.Info.CharacterName;
	}
