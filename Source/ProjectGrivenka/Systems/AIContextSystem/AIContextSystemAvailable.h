...
#include "AIContextSystemAvailable.generated.h"

// This class does not need to be modified.
UINTERFACE(MinimalAPI)
class UAIContextSystemAvailable : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class PROJECTGRIVENKA_API IAIContextSystemAvailable
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable)
	EHostilityType GetHostilityType();
};
